...
const API_KEY = `AIzaSyAiWLI4BF1D9aRqWzHRIMwt-PRb-gLbO8k`;
...
function sendMessage(){
	...
	async function generateBotResponse(botDiv) {
		const requestOptions = {
			...
			body: JSON.stringify({
				systemInstruction: {
					parts: [{ text: `You are a irish rail assistant, answer all questions about train times, ticket prices, leap cards, bike racks, and everything else about it.
                    Make all responses short, informative, and quick. if the user asks a question not related to irish rails then politely decline. do not use any * symbols in your responses`}]
				},
				contents: [{
